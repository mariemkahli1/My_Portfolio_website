      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          {/* Floating Tech Badges */}
            ...
            >
              <div className="px-3 h-10 bg-blue-600 rounded-xl flex items-center justify-center text-white text-[10px] font-bold shadow-inner whitespace-nowrap">Angular</div>
            </motion.div>
          </div>
        </motion.div>
      </div>
