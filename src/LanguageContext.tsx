...
const translations = {
  en: {
    ...
    'projects.p5.title':'Fog Computing for Vehicle Detection',
    'projects.p5.desc' : 'Distributed processing between multiple clients and a central server.',
  ...
  fr: {
    ...
    'projects.p5.title':'Fog Computing pour la détection de véhicules',
    'projects.p5.desc' : 'Traitement distribué entre plusieurs clients et un serveur central.',
    'contact.title': 'Me',
